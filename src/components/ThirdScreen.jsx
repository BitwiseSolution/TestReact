...
import ThirdScreenTable from './ThirdScreenTable';
import { FormVaidation } from './FormVaidation';
    ...
    <div className={classes.root}>
      ...
      <AppBar
        ...
        <main className={classes.content}>
          ...
          <Switch>
            <Route exact path={path} component={ThirdScreenTable}></Route>
            <Route strict path={`${path}/dashboard`} component={ThirdScreenTable} />
            ...
            <Route strict path={`${path}/preview-step`} component={Preview} />
               <Route strict path={`${path}/grid`} component={ExtendedForms} />   
          </Switch>
